...
class WazuhException(Exception):
    ...
    ERRORS = {
        ...
        1103: {
            'message': 'Invalid field in section',
        ...
        1106: {
            'message': 'Requested section not present in configuration',
            'remediation': 'Please, check your configuration file. '
            f'You can visit the official documentation (https://documentation.wazuh.com/'
            f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
            'to get more information about configuration sections',
        },
        1112: {'message': 'Empty files are not supported', 'remediation': 'Please, provide another file'},
        ...
        1124: {
            'message': 'Remote command detected',
        ...
        1125: {'message': 'Invalid ossec configuration', 'remediation': 'Please, provide a valid ossec configuration'},
        1127: {
            'message': 'Protected section was modified',
        ...
        1129: {
            'message': 'Higher version agents detected',
        ...
        1130: {
            'message': 'Public Virus Total API Key detected',
        ...
        1401: 'Invalid limit',
        1402: {
            'message': 'Invalid sort_ascending field',
            'remediation': 'Please, use only true if ascending or false if descending',
        },
        1403: {'message': 'Not a valid sort field ', 'remediation': 'Please, use only allowed sort fields'},
        1405: {
            'message': 'Specified limit exceeds maximum allowed',
            'remediation': 'Please select a limit between 1 and 1000',
        },
        1406: {'message': '0 is not a valid limit', 'remediation': 'Please select a limit between 1 and 1000'},
        ...
        1705: {'message': 'There is an agent with the same name', 'remediation': 'Please choose another name'},
        1706: {
            'message': 'There is an agent with the same IP or the IP is invalid',
        ...
        1711: {'message': 'The group already exists', 'remediation': 'Please, use another group ID'},
        1712: {
            'message': 'Default group is not deletable',
            'remediation': f'Please, visit the official documentation (https://documentation.wazuh.com/'
            f'{DOCU_VERSION}/user-manual/agents/grouping-agents.html)'
            'to get more information',
        },
        1713: {
            'message': 'Invalid group ID. Some IDs are restricted for internal purposes',
            'remediation': 'Please, use another group ID',
        },
        1722: {
            'message': 'Incorrect format for group_id',
        ...
        1734: {
            'message': 'Error removing agent from group',
        ...
        1735: {
            'message': 'Agent version is not compatible with this feature',
        ...
        1751: {
            'message': 'Could not assign agent to group',
        ...
        1757: {'message': 'Error deleting an agent', 'remediation': 'Please check all data fields and try again'},
        1761: {
            'message': 'Error sending request to the indexer',
        ...
        1908: {'message': 'Error validating configuration', 'remediation': 'Please, fix the corrupted files'},
        1911: {
            'message': 'Error parsing body request to UTF-8',
            'remediation': 'Please, check if the file content is valid UTF-8',
        },
        1912: {'message': 'Body is empty', 'remediation': 'Please, check the content of the file to be uploaded'},
        1913: {
            'message': 'Error getting manager status, directory /proc is not found or permissions to see its status '
            'are not granted',
        ...
        2709: {
            'message': 'Invalid stateful events request body. It must contain the agent metadata, headers and '
        ...
        # Security issues
        6000: {
            'message': 'Limit of login attempts reached. '
            'The current IP has been blocked due to a high number of login attempts'
        },
        6001: {
            'message': 'Maximum number of requests per minute reached',
    ...
    ERRORS.update(
        {
            key: {
                'message': "Vulnerability scan's reserved exception IDs (8001-9000). "
    ...
    def __init__(
        ...
        if not cmd_error and self._code in self.ERRORS:
            ...
            if isinstance(error_details, dict):
                code_message, code_remediation = (
                    error_details.get('message', ''),
                    error_details.get('remediation', None),
                )
            else:
            ...
            self._remediation = (
                code_remediation if extra_remediation is None else f'{code_remediation}: {extra_remediation}'
            )
        else:
    ...
    def __eq__(self, other):
        ...
        return (self._type, self._title, self._code, self._extra_message, self._extra_remediation, self._cmd_error) == (
            other._type,
            other._title,
            other._code,
